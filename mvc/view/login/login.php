<?php 
include '../../init.php';
include '../../controller/login/LoginAdmin.php';
                    ...
                    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="alert alert-info" role="alert">
                                <form action='../../controller/login/LoginAdmin.php' name="form_login" id="form_login" method="POST" enctype="multipart/form-data">
